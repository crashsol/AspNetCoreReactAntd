...
export class AbpServiceProxyScriptClient {
    ...
    getAll(type: string | null | undefined, useCache: boolean | undefined, modules: string | null | undefined, controllers: string | null | undefined, actions: string | null | undefined): Promise<string | null> {
...
export class IdentityRoleClient {
    ...
    getList(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Promise<PagedResultDtoOfIdentityRoleDto | null> {
...
export class IdentityUserClient {
    ...
    getList(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Promise<PagedResultDtoOfIdentityUserDto | null> {
...
export class BookClient {
    ...
    getList(name: string | null | undefined, typeFilters: BookType[] | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Promise<PagedResultDtoOfBookDto | null> {
        let url_ = this.baseUrl + "/api/app/book?";
        if (name !== undefined)
            url_ += "Name=" + encodeURIComponent("" + name) + "&"; 
        if (typeFilters !== undefined)
            typeFilters && typeFilters.forEach(item => { url_ += "TypeFilters=" + encodeURIComponent("" + item) + "&"; });
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
