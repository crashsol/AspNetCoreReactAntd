...
import { IdentityUserClient, IdentityUserDto } from '@/utils/HttpClient';
import { Effect } from 'dva';
import { Reducer } from 'redux';

const http = new IdentityUserClient();

// 定义IdentityUserStateModel
export interface IIdentityUserModelState {
  data: {
...
// 定义IdentityUserModel
export interface IIdentityUserModel {
  namespace: 'identityUser';
  state: IIdentityUserModelState;
  effects: {
    fetch: Effect;
    get: Effect;
    add: Effect;
...
const IdentityUserModel: IIdentityUserModel = {
  namespace: 'identityUser',
  state: {
    data: {
      list: [],
  ...
  effects: {
    *fetch({ payload }, { put, call, select }) {
      ...
      const stateTemp: IIdentityUserModelState = yield select(state => state.identityUser);
      const data = {
        list: response.items,
        pagination: {
...
export default IdentityUserModel;
